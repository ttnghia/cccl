...
template <class _Range, class _Np>
_CCCL_CONCEPT __use_passthrough = _CCCL_FRAGMENT(__use_passthrough_, _Range, _Np);
...
template <class _Range, class _Np>
_CCCL_CONCEPT __use_subrange = _CCCL_FRAGMENT(__use_subrange_, _Range, _Np);
...
template <class _Range, class _Np>
_CCCL_CONCEPT __use_generic = _CCCL_FRAGMENT(__use_generic_, _Range, _Np);
#endif // !_CCCL_HAS_CONCEPTS()
...
struct __fn
{
  ...
  [[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI constexpr auto operator()(_Range&& __range, _Np&&) const
  ...
  [[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI constexpr auto operator()(_Range&& __range, _Np&& __n) const
  ...
  [[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI constexpr auto operator()(_Np&& __n) const
