...
"""
cuda.cooperative.block_exchange
===============================
...
def striped_to_blocked(
    ...
    :type dtype: :py:class:`cuda.cooperative.experimental._typing.DtypeType`
    ...
    :type threads_per_block:
        :py:class:`cuda.cooperative.experimental._typing.DimType`
